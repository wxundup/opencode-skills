...
description: "Guidance for distinctive, intentional visual design when building new UI or reshaping an existing one. Use when building or redesigning web pages, landing pages, dashboards, or components, choosing typography, color, or layout, or when the design looks generic, templated, or AI-default. Covers aesthetic direction and avoiding common generated-page tells."
